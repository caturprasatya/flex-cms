      ...
      <div class="rounded overflow-hidden border w-full lg:w-6/12 md:w-6/12 bg-white mx-3 md:mx-0 lg:mx-0">
        ...
        <div class="flex justify-center">
          <iframe
              width="100%"
              height="400"
              :src="detailHeroSection.video_url"
              frameborder="0"
        ...
        <div class="px-3 pb-2">
          <span class="mr-2 font-extrabold font-mono text-xl pt-2"> {{detailHeroSection.title}} </span>
          <div class="pt-2">
