              ...
              <table class="min-w-max w-full table-auto">
                  <thead>
                    <tr class="bg-gray-900 text-gray-100 uppercase text-sm leading-normal">
                      ...
                      <th class="py-3 px-6 text-center">Display Client</th>
                  ...
                  <tbody v-for="(item, index) in heroSections" :key="index" class="text-gray-100 text-sm font-light">
                      <tr class="border-b border-gray-200 hover:bg-gray-400">
                          <td class="py-3 px-6 text-left w-25 whitespace-wrap">
                           ...
                           <td class="py-3 px-6 text-left">
                              <div class="flex justify-center">
                                <div class="mr-2">
                                  <img class="rounded" width="300" height="300" :src="item.imageData"/>
                                </div>
                              </div>
                            </td>
                          <td class="py-3 px-6 text-center w-40 flex-wrap">
                              <div class="flex items-center w-40">
                                  <span class="font-medium">{{ item.desc }}</span>
                              </div>
                          </td>
                           <td class="py-3 px-6 text-center w-25 whitespace-wrap">
                              <div class="flex items-center w-25">
                                  <!-- <div class="mr-2">
                                  </div> -->
                                  <span class="font-medium truncate">{{ item.show }}</span>
                              </div>
                          </td>
                          <td class="py-3 px-6 text-center">
                              <div class="flex item-center justify-center">
                                <div @click.prevent="showModal(item)" class="w-4 mr-2 h-1 transform cursor-pointerz hover:text-purple-500 hover:scale-110">
