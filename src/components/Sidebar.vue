<template>
    ...
    <div class="w-1/2 md:w-1/3 lg:w-64 fixed md:top-0 md:left-0 h-screen lg:block bg-gray-100 border-r z-30" :class="sideBarOpen ? '' : 'hidden'" id="main-nav">
          ...
          <div class="mb-4 px-4">
            ...
            <div class="w-full flex items-center text-blue-400 h-10 pl-4 active:bg-gray-200 hover:bg-gray-200 rounded-lg cursor-pointer">
          ...
          <div class="mb-4 px-4">
            ...
            <router-link to="/addFile" class="nav-link" aria-current="page" active-class="active">
            ...
            <router-link to="/galery" class="nav-link" aria-current="page">
              <div class="w-full flex items-center text-blue-400 h-10 pl-4  hover:bg-gray-200 rounded-lg cursor-pointer">
                ...
                <span class="text-gray-700">View Galery</span>
              </div>
            </router-link>
          </div>
