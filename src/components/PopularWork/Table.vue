            ...
            <div class="w-full p-10">
                ...
                <div class="bg-transparent shadow-xl rounded my-6">
                    <table class="min-w-max w-full table-auto">
                        ...
                        <tbody v-for="(item, index) in filteredProduct" :key="index" class="text-gray-100 text-sm font-light">
                            <tr class="border-b border-gray-200 hover:bg-gray-400">
                                ...
                                <td class="py-3 px-6 text-center">
                                    <div class="flex item-center justify-center">
                                        ...
                                        <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110" @click.prevent='deleteProduct(item.id, item.nameImage)'>
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
import CardModal from '@/components/PopularWork/ui/CardModal.vue'
    ...
    deleteProduct (id, nameImage) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          // const desertRef = storage.ref().child(`popularWork/${nameImage}`)
          // desertRef.delete()
          //   .then((_) => {
          this.$store.dispatch('deletePopularWorkById', id)
        //     })
        //     .catch((error) => {
        //       console.log(error)
        //     })
